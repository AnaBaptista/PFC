...
function Overload () {
  ...
  // OverloadX(2050,5,async,parser.parseDataProperties, generateXInMapWithYDataProps, 'Data') // 10000 indmaps. 5 indmap com 1 Data per doc
  ...
  // OverloadX(2050,5,async,parser.parseObjectProperties, generateXInMapWithYObjProps, 'Object') // 10000 indmaps. 5 indmap com 1 Data per doc
...
function generateXInMapWithYAnnProps (nrOfObjs, nrOfFields) {
  ...
  for(j = 0; j< nrOfObjs; j++){
    let indMap = {
      'nodeId': '5b48d69f4f0c838035e0a1b6',
      'dataFileId': '5b48d69f4f0c838035e0a1b4',
      'props': []
    }
